...
class WelcomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //********** Launch the onboarding only at first launch of the app. ************
        // Comment this section if you want to launch the onboarding all the time
        ...
        layouts = intArrayOf(
            R.layout.skip_slide1,
            R.layout.skip_slide2,
            R.layout.skip_slide3,
            R.layout.skip_slide4
        )
        // adding bottom dots
        addBottomDots(0)
        // making notification bar transparent
    ...
    private var viewPagerPageChangeListener: ViewPager.OnPageChangeListener = object :
        ...
        override fun onPageSelected(position: Int) {
            ...
            // changing the next buttonvalidate text 'NEXT' / 'GOT IT'
            if (position == layouts!!.size - 1) { // last page. make buttonvalidate text to GOT IT
